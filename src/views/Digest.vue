...
// 监听所有样式变化
watch(
  [digest, fontFamily, fontSize, lineHeight, letterSpacing, edgePadding, fontWeight, textColor, selectedBg, roundedRadius],
  () => {
    loadBackgroundImage()
    const settings = { fontFamily, fontSize, lineHeight, letterSpacing, edgePadding, fontWeight, textColor, selectedBg, roundedRadius }
